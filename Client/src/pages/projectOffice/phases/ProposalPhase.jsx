...
const ProposalPhase = () => {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("announcements-proposal");
    if (saved) {
      ...
      const initial = [
        {
          srNo: 1,
          subject: "Proposal Guidelines",
          date: "2025-04-05",
          description: "Submit your project proposals",
          attachment: null
        }
      ];
      setAnnouncements(initial);
      localStorage.setItem("announcements-proposal", JSON.stringify(initial));
    }

    const savedSubmissions = localStorage.getItem("proposal-submissions");
    if (savedSubmissions) {
      ...
      const defaultSubmissions = [
        {
          ...
          endDate: "2025-04-15",
          fileName: "smart_agriculture_proposal.pdf"
        }
      ];
      setSubmissions(defaultSubmissions);
      localStorage.setItem("proposal-submissions", JSON.stringify(defaultSubmissions));
    }
  }, []);
  ...
  const handleAddAnnouncement = (newAnnouncement) => {
    ...
    localStorage.setItem("announcements-proposal", JSON.stringify(updated));
  };
    ...
    "Material": (
      <DataTable
        ...
        data={[{
          ...
          download: "proposal_template.docx"
        }].map(m => [
          m.srNo,
          m.material,
          m.description,
      ...
      <DataTable
        ...
        data={submissions.map(sub => [
          ...
          <button
            ...
            onClick={() => navigate(`/po/dashboard/bsse/current-projects/proposal/${sub.srNo}`)}
          >
            View
          </button>
        ])}
