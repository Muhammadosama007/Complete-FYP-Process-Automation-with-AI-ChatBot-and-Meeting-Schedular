...
const FinalPhase4 = () => {
    ...
    useEffect(() => {
        const saved = localStorage.getItem("announcements-finalphase4");
        if (saved) {
            ...
            const initial = [
                {
                    ...
                    date: "2025-04-01",
                    description: "Details for FinalPhase4",
                    attachment: null
                }
            ];
            setAnnouncements(initial);
            localStorage.setItem("announcements-finalphase4", JSON.stringify(initial));
        }

        const savedSubmissions = localStorage.getItem("finalphase4-submissions");
        if (savedSubmissions) {
            ...
            localStorage.setItem("finalphase4-submissions", JSON.stringify(defaultSubmissions));
        }

        const savedMaterials = localStorage.getItem("finalphase4-materials");
        if (savedMaterials) {
            ...
            localStorage.setItem("finalphase4-materials", JSON.stringify(defaultMaterials));
        }
    }, []);
    ...
    const handleAddAnnouncement = (newAnnouncement) => {
        ...
        localStorage.setItem("announcements-finalphase4", JSON.stringify(updated));
    };
    ...
    const handleAddMaterial = (newMaterial) => {
        ...
        localStorage.setItem("finalphase4-materials", JSON.stringify(updated));
    };
            ...
            <DataTable
                ...
                data={submissions.map(sub => [
                    ...
                    <button
                        ...
                        onClick={() => navigate(`/po/dashboard/bsse/current-projects/final-phase4/` + sub.srNo)}
                    >
                        View
                    </button>
                ])}
